...
Dado que las imágenes generadas por GitHub Actions se alojan en GHCR, necesitas iniciar sesión en el registro usando un **Personal Access Token (PAT)** de GitHub (con permiso `read:packages`).
